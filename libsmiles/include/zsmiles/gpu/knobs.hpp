...
#define GRID_SIZE            32
#define NUM_WORK_GROUP_BLOCK WARP_SIZE / WORK_GROUP_SIZE
#define NUM_WORK_GROUP       GRID_SIZE* NUM_WORK_GROUP_BLOCK

#define MAX_SMILES_LEN   256
#define SMILES_PER_BLOCK 64 * 4
